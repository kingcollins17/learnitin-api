...
class OTPRepository:
    ...
    async def delete_unused_otps(self, email: str) -> None:
        """Delete unused OTPs for the given email."""
    ...
    async def get_valid_otp(self, code: str, email: str) -> Optional[OTP]:
        """Get a valid, unused OTP by code and email."""
